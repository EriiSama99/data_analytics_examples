...
readLines("HWData/asec2014_pubuse.dat",n=1)
...
asec2014 <- read_fwf(file="HWData/asec2014_pubuse.dat", fwf_positions(c(1,2,25,39,42,49,53),c(1,6,25,39,43,51,53),col_names = c("type","hid","htype","region","state","country","metro_status")))
...
for (year in years_list){ 
  ...
  filename = paste0("HWData/asec", year, "_pubuse.dat")
